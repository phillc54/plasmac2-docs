...
You will then be prompted for the directory name of the new config which by default will be the original QtPlasmaC directory name appended with __plasmac2_.

If you change the new directory name to the same as the original QtPlasmaC config then the QtPlasmaC directory name will be appended with __qtplasmac_.
