...
HALFILE         = plasmac.tcl (the standard plasmac2 HAL file ) +
...
*Version Information* - plasmac2 will display versioning information in the title of the main window.
The information will be displayed as `plasmac2 v2.N + AXIS N.N (FN)` where `N` is the version of plasmac2, `N.N` is the version of AXIS, and `FN` is the name of the loaded G-code program.
